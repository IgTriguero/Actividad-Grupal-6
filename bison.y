...
DECL: NOMBRE_VARIABLE COLON DECLINTEGER COLON EQUAL NOMBRE_VARIABLE SEMICOLON {} //variable : Integer := VARIABLE + ARIT ;
	| NOMBRE_VARIABLE COLON DECLINTEGER COLON EQUAL NOMBRE_VARIABLE OP_ARIT NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLINTEGER COLON EQUAL NOMBRE_VARIABLE OP_ARIT ARIT SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLINTEGER COLON EQUAL ARIT OP_ARIT NOMBRE_VARIABLE SEMICOLON {}
	...
	| NOMBRE_VARIABLE COLON DECLINTEGER SEMICOLON {}

	| NOMBRE_VARIABLE COLON DECLFLOAT COLON EQUAL NOMBRE_VARIABLE SEMICOLON {} //variable : Float := cosas ;
	| NOMBRE_VARIABLE COLON DECLFLOAT COLON EQUAL NOMBRE_VARIABLE OP_ARIT NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLFLOAT COLON EQUAL NOMBRE_VARIABLE OP_ARIT ARIT2 SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLFLOAT COLON EQUAL ARIT2 OP_ARIT NOMBRE_VARIABLE SEMICOLON {} //ignore ARIT OP VAR
	...
	$$.a = createASTAsignacion($6.a);}
	| NOMBRE_VARIABLE COLON DECLFLOAT SEMICOLON {}

	| NOMBRE_VARIABLE COLON DECLBOOLEAN COLON EQUAL NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLBOOLEAN COLON EQUAL NOMBRE_VARIABLE OP_BOOLEANO NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLBOOLEAN COLON EQUAL NOMBRE_VARIABLE OP_BOOLEANO ENTERO SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLBOOLEAN COLON EQUAL NOMBRE_VARIABLE OP_BOOLEANO FLOAT SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLBOOLEAN COLON EQUAL ENTERO OP_BOOLEANO NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLBOOLEAN COLON EQUAL FLOAT OP_BOOLEANO NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLBOOLEAN COLON EQUAL BOOL SEMICOLON {}
	| NOMBRE_VARIABLE COLON DECLBOOLEAN COLON EQUAL BOOLEAN SEMICOLON {}
	...
	| NOMBRE_VARIABLE COLON EQUAL NOMBRE_VARIABLE SEMICOLON {} //variable : Integer := VARIABLE + ARIT ;
	| NOMBRE_VARIABLE COLON EQUAL NOMBRE_VARIABLE OP_ARIT NOMBRE_VARIABLE SEMICOLON {}
	...
	| NOMBRE_VARIABLE COLON EQUAL NOMBRE_VARIABLE OP_ARIT ARIT2 SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL ARIT OP_ARIT NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL ARIT2 OP_ARIT NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL ARIT SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL ARIT2 SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL NOMBRE_VARIABLE OP_BOOLEANO NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL NOMBRE_VARIABLE OP_BOOLEANO ENTERO SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL NOMBRE_VARIABLE OP_BOOLEANO FLOAT SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL ENTERO OP_BOOLEANO NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL FLOAT OP_BOOLEANO NOMBRE_VARIABLE SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL BOOL SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL BOOLEAN SEMICOLON {}
	| NOMBRE_VARIABLE COLON EQUAL STRING SEMICOLON {}

	| TYPE NOMBRE_VARIABLE IS RANGE ENTERO DOTDOT ENTERO SEMICOLON {}
	| TYPE NOMBRE_VARIABLE IS DECLARRAY ABRIR_PARENTESIS ENTERO DOTDOT ENTERO CERRAR_PARENTESIS OF NOMBRE_VARIABLE SEMICOLON {}
